...
public class MainRegister1 extends AppCompatActivity {
    /*EditText username;
    EditText password;
    EditText age;
    RadioGroup sex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(MainRegister1.this, " 회원가입 성공 ", Toast.LENGTH_LONG).show();

                Intent intent = new Intent(MainRegister1.this,MainLogin.class);
