...
/*public class TestMember extends AppCompatActivity {
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(TestMember.this,
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                personalData.setMember_userid(userid);
                personalData.setMember_name(name);
                personalData.setMember_password(password);
                personalData.setMember_username(username);
